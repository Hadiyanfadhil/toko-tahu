            ...
            success:function(response){
                ...
                if(response.wishlists.length != 0){
                    for(let i=0; i < response.wishlists.length; i++){
                        let price = response.wishlists[i].discount_price == null || response.wishlists[i].discount_price == 0 ?
                            response.wishlists[i].selling_price :
                            response.wishlists[i].selling_price - response.wishlists[i].discount_price;
                        wishlistHtml += `
