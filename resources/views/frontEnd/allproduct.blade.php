                                ...
                                <div class="card bg-white product-card p-3 mb-3">
                                    ...
                                    <div class="card-body px-0 pb-0">
                                        ...
                                        <div class="d-flex align-items-baseline">
                                            @php
                                            $formattedPrice = "Rp. " . number_format($item->selling_price, 0, ',', '.');
                                            @endphp
                                            @if (!empty($item->discount_price))
                                            @php
                                            $discountedPrice = "Rp. " . number_format($item->selling_price - $item->discount_price, 0, ',', '.');
                                            @endphp
                                            <h6 class="mb-0 text-danger">{{ $discountedPrice }}</h6>
                                            <p class="h6 mb-0 ms-2 text-black-50 text-decoration-line-through">{{ $formattedPrice }}</p>
                                            @else
                                            <h6 class="mb-0 text-danger">{{ $formattedPrice }}</h6>
                                            @endif
                                        </div>
                                    </div>
                                </div>
